...
def pandas_to_csv_filestore(df: PandasDataFrame, csv_file_name: str, prefix: str, *args, **kwargs) -> str:
    ...
    try:
        df.to_csv(filestore_path, index=False, *args, **kwargs)
...
#             zip_file.write(entry, entry.relative_to(dir))
    ...
    html_url = os.path.join('https://adb-2606104010931262.2.azuredatabricks.net/files', root_dbfs_prefix_to_zip_remove_first_2_parts, output_zipfile_name)
